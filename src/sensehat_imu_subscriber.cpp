...
sensehat_driver::SenseHatIMUSubscriber::SenseHatIMUSubscriber(const ros::NodeHandle& nh) : nh_(nh) 
{
  sensehat_imu_subscriber_ = nh_.subscribe("imu_orientation_quaternion", 5, &SenseHatIMUSubscriber::IMUCallback, this);
}

void sensehat_driver::SenseHatIMUSubscriber::IMUCallback(const sensor_msgs::Imu::ConstPtr& imu_msg) 
{
  /*
...
sensehat_driver::SenseHatIMUSubscriber::~SenseHatIMUSubscriber() 
{
} 
